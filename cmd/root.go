...
import (
	...
	dbInfra "github.com/chseidler/hexagonal-go-example/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hexagonal-go-example.yaml)")
